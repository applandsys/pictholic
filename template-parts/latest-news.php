                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="prs_ln_right_first_box_wrapper">
                                <div class="prs_in_right_box_img_wrapper">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/content/nl2.jpg" alt="news_img" />
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="prs_ln_right_first_box_wrapper2">
                                <div class="prs_in_right_box_img_wrapper">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/content/nl3.jpg" alt="news_img" />
                                </div>
                                <div class="prs_in_right_box_img_cont_wrapper">
                                    <h2><a href="#">The News of theater</a></h2>
                                    <h3>28 feb 2022</h3>
